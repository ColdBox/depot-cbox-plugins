...
To use:
<cfscript>
	variables.joStringBuilder = createObject('component', 'StringBuilder');
	variables.joStringBuilder.append(variables.someDataVar);
	writeOutput(variables.joStringBuilder.getString());
</cfscript>
...
When a StringBuilder object is created it has a capacity, which is the number of characters that the StringBuilder will contain if full. If the default constructor is called with no parameters this capacity is set to 16, otherwise an int may be passed as a parameter to specify the capacity. Another constructor allows an initial set of characters to be passed as a parameter, in this case the capacity of the StringBuilder will be the number of characters in the initial string plus a further 16. The following example shows the possible ways of building StringBuilder objects.

StringBuilder = strbuf new StringBuilder (); // capacity = 16
StringBuilder = strbuf2 new StringBuilder (25); // capacity = 25
StringBuilder = strbuf3 new StringBuilder ("Java"); // capacity = 4 + 16 = 20
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<!--- Constructor --->
	<cffunction name="init" access="public" returntype="StringBuilder" output="false">
		<cfscript>
			
			setpluginName("StringBuilder");
			setpluginVersion("1.0");
			setpluginDescription("This is a facade to the java StringBuilder class.");
			setpluginAuthor("Luis Majano");
			setpluginAuthorURL("http://www.coldbox.org");
			
			// init the string buffer
			variables.buffer = createObject("java","java.lang.StringBuilder");
	...
	<!--- Setup Constructor --->
	<cffunction name="setup" access="public" returntype="any" output="false" hint="initializes the StringBuilder CF/java object">
		<!--- ************************************************************* --->
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<!--- Delete --->
	<cffunction name="delete" returntype="void" access="public" output="false" hint="Removes the characters in a substring of this StringBuilder.">
		<!--- ************************************************************* --->
	...
	<!--- Replace a string --->
	<cffunction name="replaceStr" returntype="void" access="public" output="false" hint="Replaces the chracters in a substring of this StringBuilder with characters in the specified inStr">
		<!--- ************************************************************* --->
		<cfargument name="startPos" type="numeric" 	required="Yes" hint="The beginning index, inclusive." />
		<cfargument name="endPos" 	type="numeric" 	required="Yes" hint="The ending index, exclusive." />
		<cfargument name="inStr" 	type="string" 	required="Yes" hint="a string" />
	...
	<!--- Sub String --->
	<cffunction name="substring" returntype="string" access="public" output="false" hint="Returns a new String that contains a subsequence of characters currently contained in this StringBuilder.The substring begins at the specified index and extends to the end of the StringBuilder.">
		<!--- ************************************************************* --->
		<cfargument name="startPos" type="numeric" required="Yes" hint="The beginning index, inclusive." />
	...
	<cffunction name="getStringBuilder" returntype="any" access="public" output="false" hint="Return the StringBuilder Java Object">
